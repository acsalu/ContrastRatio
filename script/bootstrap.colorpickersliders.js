        ...
        return this.each(function() {
            ...
            function _getControllerHtml() {
                ...
                if (settings.order.hsl !== false) {
                    sliders[settings.order.hsl] = '<div id="cp-slider-group-hsl" class="cp-slider-group"><div class="cp-slider cp-hslhue cp-transparency"><span></span><div class="cp-marker">H</div></div><div class="cp-slider cp-hslsaturation cp-transparency"><span></span><div class="cp-marker">S</div></div><div class="cp-slider cp-hsllightness cp-transparency"><span></span><div class="cp-marker">L</div></div></div>';
                ...
                if (settings.order.rgb !== false) {
                    sliders[settings.order.rgb] = '<div id="cp-slider-group-rgb" class="cp-slider-group"><div class="cp-slider cp-rgbred cp-transparency"><span></span><div class="cp-marker">R</div></div><div class="cp-slider cp-rgbgreen cp-transparency"><span></span><div class="cp-marker">G</div></div><div class="cp-slider cp-rgbblue cp-transparency"><span></span><div class="cp-marker">B</div></div></div>';
